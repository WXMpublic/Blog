...
> Suggested Chinese Reference
>
> 1. <https://www.liaoxuefeng.com/wiki/0013739516305929606dd18361248578c67b8067c8c017b000>
> 2. <https://blog.csdn.net/qq_32452623/article/details/78276451>

Note: **Only plain texts are welcomed in a Git system, try not include too much binary files (etc. `.docx`, `.paper`, `.jpg`) in the system. The necessary binaries is better to be stored elsewhere (etc. image hosts) and only keep their pathes in the Git system. Markdown is recommended for texting in Git.**
